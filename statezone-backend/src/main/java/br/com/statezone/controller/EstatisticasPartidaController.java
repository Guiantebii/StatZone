...
public class EstatisticasPartidaController {
    ...
    public ResponseEntity<EstatisticasPartidaResponseDto> get(@PathVariable Long partidaId) {
        return ResponseEntity.ok(estatisticasPartidaService.gerar(partidaId));
    }
}