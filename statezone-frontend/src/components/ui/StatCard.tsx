...
export default function StatCard({ label, value, sublabel, trend }: StatCardProps) {
  return (
    <Card className="p-4 min-h-[110px] flex flex-col justify-between relative overflow-hidden group">
      ...
      <p className="text-[11px] uppercase tracking-widest text-slate-500 font-semibold relative">{label}</p>

      <div className="relative">
        <div className="text-3xl font-extrabold text-slate-100 font-mono tracking-tight">{value}</div>
